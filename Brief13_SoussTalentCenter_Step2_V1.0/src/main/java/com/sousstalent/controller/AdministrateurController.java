...
public class AdministrateurController {
	...
	public ResponseEntity<Administrateur> save(@RequestBody Administrateur administrateur) {
		return new ResponseEntity<Administrateur>(administrateurService.saveAdministrateur(administrateur), HttpStatus.CREATED);
	}
	...
	public ResponseEntity<Administrateur> getAdministrateurById(@PathVariable("id") long administrateurId) {
		return new ResponseEntity<Administrateur>(administrateurService.getAdministrateurById(administrateurId), HttpStatus.OK);
	}
