                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold"><%= employee.getFirstname() %> <%= employee.getLastname() %> </p>
                      ...
                      <td>
                     <a class="px-2 py-1 font-semibold leading-tight text-orange-700 bg-orange-100 rounded-full dark:text-white dark:bg-orange-600" id="edit" href="edit?id_employees=<%=employee.getId_employee()%>">Edit</a>
                     &nbsp;&nbsp;&nbsp;&nbsp;
                     <a class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:text-red-100 dark:bg-red-700" href="delete?id_employees=<%=employee.getId_employee()%>">Delete</a>                     
                    </td>
